...
public class Read extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagen/Login_1.png"))); // NOI18N
...
// TODO add your handling code here:
    ...
    private void txt_phonenumberKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_phonenumberKeyTyped
       char solonumero=evt.getKeyChar();
                ...
                /*
                int digitos = Integer.parseInt(txt_phonenumber.getText());
                int valida = (int)(Math.log10(digitos)+1);
            if (valida ==10 ){
                getToolkit().beep();
                //evt.consume();
